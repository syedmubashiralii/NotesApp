          ...
          children: [
            ...
            Container(
              ...
              child: TextField(
                ...
                onChanged: (value) {},
                onSubmitted: (val) {
                  if (todoController.todoNameController.text.isEmpty) {
                    DefaultSnackbar.show("Trouble", "Please enter todo name");
                  } else {
                    final String uid = const Uuid().v4();
                    todoController.addUpdateTodo(TodoModel(
                        uid: uid,
                        name: todoController.todoNameController.text,
                        completed: false,
                        date: DateTime.now()));
